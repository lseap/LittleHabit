...
Page({
  ...
  editRecord: function() {
    ...
    wx.request({
      ...
      success(res) {
        that.setData({
          simpleRecordContent: res.data.simpleRecordContent
        })
      }
    })
    that.setData({
      maskFlag: true,
      simpleRecordFlag: true
    })
  },
    ...
    wx.request({
      ...
      success(res) {
        ...
        that.setData({
          ...
          finish: res.data.finish,
          ccontinue: res.data.continuousDay,
          highcontinue: res.data.maxContinuousDay,
          contribute: res.data.contributeDay,
          simpleRecord_Data: res.data.simpleRecordData,
          simpleRecord_Content: res.data.simpleRecordContent,
