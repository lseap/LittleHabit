// pages/customizeHabit/customizeHabit.js
var app = getApp()
...
Page({
  ...
  data: {
    ...
    p1background: "#BAE6D6",
    p2background: "#FFFFFF",
    imgsrc: "../../img/icons8-tennis-racquet-100.png"
  },
   ...
   */
  onShow: function() {
    console.log(app.globalData.newhabitpicture)
    if (app.globalData.newhabitpicture != null) {
      this.setData({
        imgsrc: app.globalData.newhabitpicture
      })
    }
  },
